...
<html>
    ...
    <body> 
        <div>
            ...
            <table>
                <thead><th>Код</th><th>КодТура</th><th>Дата отправления</th><th>Номер отправления</th></thead>
                <?php
                for($i=0; $i<count($info); $i++)
                {
                    ...
                    echo "<tr><td>$idTravel</td><td>$idTour</td><td>$dateDDeparture</td><td>$routeDDeparture</td></tr>";
                }
                ?>
            </table>
        </div>
